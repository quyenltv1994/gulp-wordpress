...
Agile Store Locator is a premium Store Finder plugin designed to offer you immediate access to all the nearby physical stores in your searched area, It enables you to find the store locations and their direction from your current position through Google Maps V3.
...
* Sort Stores List the distance.
* Category Management with Markers
* Google API Key insertion Option
* Set Default Lat/Lng for Google Maps
* Sort Map Screen View
...
* Google Maps regions and Language feature
* Delete all stores Option
* and so much more

= Available Translations =
* German, French, Spanish, Italian, Arabic, Dutch, Portuguese, Japanese and others
...
* Add Markers to Each Category, Switch between Category Markers and Default Markers.
...
* Set Default Lat/Lng on your Map.
...
* Choose Maps look n feel from Snazzy Maps.
...
* Logo Manager with Listing.
* Full Screen Map and Fixed.
* Search on Bound Button.
* Show Limited Stores.
* Select Default Category.
* Show Center Button.
* 65+ Advance Options for Store Locator Admin.
* Geo-Directory Supported.

Real Estate and Deals Maps are included in the plugin which makes it complete Location Finder plugin with beautiful list styling.

For Help, Please create a (support ticket)[https://wordpress.org/support/plugin/agile-store-locator] here, we will reply at our earliest.
...
= How to add it to Page or Post? =
With the easy shortcode, you can add Store Locator on a page, paste the [ASL_STORELOCATOR] shortcode on your page or post.

= Why Search is not working? =
Either Google Maps key is not added to service or you have [Multiple inclusion of Google Maps API Key](https://agilestorelocator.com/wiki/plugins-map-slow-malfunctioning/)
...
= How to add a site link to the listing?
...
= How can we customize the Store Locator Listing 
To change the address format, or Add/Remove column, please follow the [guide article](https://agilestorelocator.com/blog/customize-google-marker-infowindow-sidebar-store-locator/).

== Screenshots ==

1. FrontView
2. FrontView with Infobox
3. FrontView with Direction Dialog
...
= 1.1.0 =
Added Distance to List and InfoWindow
