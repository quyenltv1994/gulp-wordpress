...
<div id="asl-storelocator" class="container no-pad storelocator-main asl-p-cont asl-bg-<?php echo $all_configs['color_scheme_2'].$class; ?> asl-text-<?php echo $all_configs['font_color_scheme'] ?>">
  <div class="row">
    ...
    <div class="col-sm-8 col-xs-12 asl-map">
      <div class="store-locator">
        ...
        <div class=" search_filter inside-map">
            <p>
              <input type="text" id="auto-complete-search" class="form-control" placeholder="<?php echo __( 'Find A Store','asl_locator') ?>">
