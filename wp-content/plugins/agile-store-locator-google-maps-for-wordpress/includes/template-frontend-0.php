...
<div id="asl-storelocator" class="container no-pad storelocator-main asl-p-cont asl-layout-<?php echo $all_configs['layout']; ?> asl-bg-<?php echo $all_configs['color_scheme'].$class; ?> asl-text-<?php echo $all_configs['font_color_scheme'] ?>">
...
<div class="row Filter_section">
    <div class="col-xs-12 col-sm-4 search_filter">
        ...
        <p>
          <input type="text" data-submit="disable" data-provide="typeahead" tabindex="2" id="auto-complete-search"  class="form-control typeahead">
    ...
    <div class="col-sm-4 col-xs-12 asl-panel">
      ...
      <div class="col-xs-12 inside search_filter">
        ...
        <div class="asl-store-search">
            <input type="text" id="auto-complete-search" class="form-control" placeholder="<?php echo __( 'Enter a Location', 'asl_locator') ?>">
...
<script id="tmpl_list_item" type="text/x-jsrender">
  <div class="item" data-id="{{:id}}">
    ...
    <div class="col-md-9 col-xs-9 addr-sec">
      ...
      {{/if}}
      {{if email}}
      <p class="p-area"><span class="glyphicon glyphicon-envelope"></span>{{:email}}</p>
      {{/if}}
      {{if fax}}
        <p class="p-area"><span class="glyphicon glyphicon-fax"></span> <?php echo __('Fax', 'asl_locator') ?>:{{:fax}}</p>
      {{/if}}  
      {{if c_names}}
    ...
    {{if description_2}}
    <div class="col-xs-12">
      <a onclick="javascript:asl_jQuery(this).next().next().slideToggle(100);asl_jQuery(this).next().show();asl_jQuery(this).hide()" class="asl_Readmore_button"><?php echo __( 'Read more','asl_locator') ?></a>
      <a onclick="javascript:asl_jQuery(this).next().slideToggle(100);asl_jQuery(this).prev().show();asl_jQuery(this).hide()" style="display:none" class="asl_Readmore_button"><?php echo __( 'Hide Details','asl_locator') ?></a>
...
<div class="image_map_popup" style="display:none"><img src="{{:URL}}public/Logo/{{:path}}" /></div>
  ...
  <div class="infowindowContent">
    <div class="info-addr">
      ...
      {{/if}}
      {{if end_time && start_time}}
      <div class="p-time"><span class="glyphicon glyphicon-time"></span> {{:start_time}} - {{:end_time}}</div>
      {{/if}}
      {{if days_str}}
...
<script type="text/javascript">
//jQuery('#asl-storelocator').css('height',jQuery(window).height()+'px')
</script>