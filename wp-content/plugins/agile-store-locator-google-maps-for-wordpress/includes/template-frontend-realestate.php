    ...
    <div class="col-sm-8 col-xs-12 asl-map">
      <div class="store-locator">
        ...
        <div class=" search_filter inside-map">
            <p>
              <input type="text" id="auto-complete-search" class="form-control" placeholder="<?php echo __('Search a Location', 'asl_locator') ?>">
    ...
    <div class="col-xs-8 data-section">
          ...
          <div class="addr-sec">
              ...
              <div class="sec-1">
                  ...
                  {{/if}}
                  {{if email}}
                  <p class="p-area"><span class="glyphicon glyphicon-envelope"></span><a href="{{:email}}">{{:email}}</a></p>
                  {{/if}}
              </div>
              <div class="sec-1">
                  {{if end_time && start_time}}
                  <p class="p-time"><span class="glyphicon glyphicon-time"></span><?php echo __('Visit Time', 'asl_locator') ?>: {{:start_time}} - {{:end_time}}</p>
                  {{/if}}
                  {{if days_str}}
