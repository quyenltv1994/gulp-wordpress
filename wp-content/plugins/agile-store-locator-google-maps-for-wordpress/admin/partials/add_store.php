...
<div class="container asl-p-cont asl-new-bg">
	<div class="row asl-inner-cont">
		<div class="col-md-12">
		<h3 class="alert alert-info head-1">New Store</h3>
							...
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-3">
			                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addmarkermodel">New Marker</button>
			                            </div>
									</div>
	                                ...
	                                <table class="days_table hide">
	                                    ...
	                                    <tbody>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_0]" class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[end_time_0]"   class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_1]"  class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text"  name="datatime[end_time_1]"  class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_2]"  class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text"  name="datatime[end_time_2]"  class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_3]"  class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text"  name="datatime[end_time_3]"  class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_4]"  class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text"  name="datatime[end_time_4]"  class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_5]"  class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[end_time_5]"   class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[start_time_6]" class="form-control start_time timepicker" placeholder="Start Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div class="input-append input-group bootstrap-timepicker">
	                                                  <input type="text" name="datatime[end_time_6]"  class="form-control end_time timepicker" placeholder="End Time">
	                                                  <span class="input-group-addon add-on"><i class="glyphicon glyphicon-time icon-time"></i></span>
	                                                </div>
	                                            </td>
	                                        </tr>
